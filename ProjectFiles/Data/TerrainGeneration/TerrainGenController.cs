namespace FilipRuman.ProceduralMapGen {
    ...
    public partial class TerrainGenController : Node {
        ...
        [Export] StructuresSpawningController structuresSpawningController;
        ...
        [Export] public Vector2 minMaxHeightForMaterialsAndObjects;
        ...
        void SpreadSpawningTerrain(bool spawnAll) {
            ...
            for (int x = minX; x < maxX; x++) {
                for (int y = minY; y < maxY; y++) {
                    ...
                    // structuresSpawningController.SpawnStructureScenesOnTerrain(new Vector2(x, y), node);
        ...
        public float RealTerrainSize => terrainRawSize * terrainScale;
